...
public class MovieInfoService {
	...
	public List<MovieAvgRating> getMovieCatalog() {
		...
		// restTemplate.exchange("http://ratings-data-service/ratingsdata/rating",
		...
		// restTemplate.exchange("http://movie-info-service/movies/getAll",
	...
	@HystrixCommand(fallbackMethod = "getRatingResponseFallback")
	public List<Rating> getRatingResponse() {

		ResponseEntity<List<Rating>> ratingResponse = restTemplate.exchange(
				"http://ratings-data-service/ratingsdata/rating", HttpMethod.GET, null,
	...
	public List<Rating> getRatingResponseFallback() {

		return Arrays.asList(new Rating(0, 0, 0, null));
	...
	public List<Movie> getMovieResponseFallback() {

		return Arrays.asList(new Movie(0, "None", "None"));
